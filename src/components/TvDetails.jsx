  ...
  return info ?(
    ...
    >
        ...
        <img 
         ...
         <div className='content ml-[5%] text-white'>
            ...
            <h1 className='text-5xl font-black '>
                ...
                <small className="text-2xl font-bold text-zinc-300">({info.deatil.first_air_date.split("-")[0]})</small>
            </h1>
        ...
        <div className="w-[100%] flex overflow-y-hidden mb-5 p-5">
            {info.deatil.seasons.map((s,i) =>(
                <div className="mr-2">
                  <img 
                   key={i}
                   className='w-[14vw] h-[30vh] shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] ' src={`https://image.tmdb.org/t/p/original/${s.poster_path}`} alt=""/>
